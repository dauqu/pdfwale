        ...
        <form class="space-y-6" action="./backend/add_ledger.php">
            ...
            <div class="flex justify-between">
                <div class="w-full mr-2">
                    ...
                    <p class="text-white text-xl">3000</p>
                </div>
                <div class="w-full flex flex-col mr-5">
                    <div class="form-control">
                        <label class="label cursor-pointer w-[100px]">
                            ...
                            <input type="radio" name="type" value="debit" class="radio checked:bg-green-500" checked require />
                        </label>
                    </div>
                    <div class="form-control">
                        <label class="label cursor-pointer w-[100px]">
                            ...
                            <input type="radio" name="type" value="credit" class="radio checked:bg-red-500" require />
                        </label>
                    </div>
                </div>
                <div class="w-full mr-2">
